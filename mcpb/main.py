"""Entry point of the Claude Desktop bundle for korea-scholarship-mcp.
...
try:
    from korea_scholarship_mcp import main
    ...
    sys.stderr.write(
        f"korea-scholarship-mcp: cannot import its package under Python {sys.version.split()[0]} "
        f"at {sys.executable}: {exc}\n"
        f"korea-scholarship-mcp: supported Python is >=3.10; this file is meant to be run by uv "
